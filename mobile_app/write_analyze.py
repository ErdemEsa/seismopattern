# -*- coding: utf-8 -*-
"""Adds Analyze screen (manual lat/lon input) and updates navigation."""
...
# ============================================================
FILES["screens/analyze_screen.dart"] = r'''
import 'dart:convert';
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'stediğiniz herhangi bir noktada kısa vadeli belirsizlik skoru hesaplayın.',
